...
const EmbeddedWallet = () => {
  ...
  const onTransfer = async () => {
    ...
    try {
      ...
      await embeddedWallet.switchChain(31337)
  ...
  return (
    <AuthenticatedPage>
      ...
      <Section>
        ...
        <p className='mt-2 text-sm text-gray-600'>
          Transfer Goerli ETH from your embedded wallet. Enter a valid recipient address to enable the button.
        </p>
        <input
          type='text'
          ...
          placeholder='0x123...'
          autoComplete='off'
          onChange={(e: React.FormEvent<HTMLInputElement>) => setRecipientAddress(e.currentTarget.value)}
