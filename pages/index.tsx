...
const Index = () => {
  ...
  return (
    <>
      ...
      <main>
        <div className='flex h-screen w-screen flex-col items-center justify-center bg-[#D0FD52]'>
          <h2 className={`my-4 font-semibold text-gray-800 text-3xl ${akira.className}`}>
            BAGZ
          </h2>
          <div className='mt-2 w-1/2'>
            {!isInstalled && isAndroid
              ...
              : (
                <button
                  className='my-4 w-full rounded-mdpx-3.5 py-2.5 text-sm font-semibold text-black bg-white shadow-sm disabled:bg-indigo-400'
                  onClick={login}
